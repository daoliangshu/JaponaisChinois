...
public class LettrabulleView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public ArrayList<BubbleLine> wordLines;
    ...
    */
    ...
    public void initLines() {
        ...
        BubbleLine.rectGameBoard = new Rect(0, 0, scrW, (int) (LB_Config.GAME_BOARD_RATIO * scrH));
        ...
        for (int i = 0; i < numWordLine; i++) {
            ...
            wordLines.add(new BubbleLine(myContext));
    ...
    private String getRandFromDB() {
        int iteCount = 0;
        HashMap<String, String> res;
        do {
            res = myDBHelper.getEntryById(myDBHelper.getRandId(Settings.curLesson));
            iteCount += 1;
